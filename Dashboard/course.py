...
class CourseClass:
    def __init__(self, root):
        ...
        self.root.focus_force()
         ...
         # Define Title 
        title = Label(self.root,text="Manage Course Details",font=("goudy old style",20,"bold"), bg="#033054", fg="white").place(x=10,y=15,width=1380,height=35)
        # Variables
        ...
        lbl_duration = Label(self.root, text="Duation", font=("goudy old style",15,'bold'),bg='white').place(x=10,y=100)
