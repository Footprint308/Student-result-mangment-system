...
class reportClass:
    def __init__(self, root):
        ...
        self.root.geometry("1400x550+70+130")
        self.root.config(bg = "white")
        self.root.focus_force()

        # Define Title 
        title = Label(self.root,text="View Student Results",font=("goudy old style",20,"bold"), bg="orange", fg="#262626").place(x=10,y=15,width=1380,height=50)
        ...
        # Result labels
        lbl_roll = Label(self.root, text="Roll No", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=150,y=230,height=50,width=150)
        lbl_name = Label(self.root, text="Name", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=300,y=230,height=50,width=150)
        lbl_course = Label(self.root, text="Course", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=450,y=230,height=50,width=150)
        lbl_marks = Label(self.root, text="Marks Obtained", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=600,y=230,height=50,width=150)
        lbl_full = Label(self.root, text="Toatl Marks", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=750,y=230,height=50,width=150)
        lbl_per = Label(self.root, text="Percentage", font=("goudy old style",15,'bold'),bg='white',bd=2, relief=GROOVE).place(x=900,y=230,height=50,width=150)
        ...
        self.full.place(x=750,y=280,height=50,width=150)
