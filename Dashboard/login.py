        ...
        if self.txt_email.get()=="":
            ...
            try:
                ...
                if row==None:
                    ...
                    btn_change_password=Button(self.root2,text="Change Password",font=("times new roman",15,"bold"),fg="white",bg="green",cursor="hand2",command=self.forget_password).place(x=90,y=340)
